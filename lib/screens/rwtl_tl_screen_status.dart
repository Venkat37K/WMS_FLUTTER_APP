...
class RwtlTlStatusScreen extends StatefulWidget {
  const RwtlTlStatusScreen({super.key});

  @override
  State<RwtlTlStatusScreen> createState() => _RwtlTlStatusScreenState();
}
...
class _RwtlTlStatusScreenState extends State<RwtlTlStatusScreen> {
  ...
  // Display tuning (kept same as TL page)
  ...
  // Tile titles per your sheet ("RTL - 1" .. "RTL - 6")
  String _titleFor(int i) => 'RTL - $i';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('RWTL • Pressure', style: TextStyle(color: Colors.white)),
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      ...result.items.map((r) {
                        ...
                        // r.index here is A1..A6 – we want titles RTL - 1..6
                        final rtlIndex = r.index; // 1..6 already
                        return Padding(
                          padding: const EdgeInsets.only(bottom: 12),
                          child: _PTTile(
                            title: _titleFor(rtlIndex),
                            value: r.value,
                            unit: unit,
                            statusText: st.text,
...
// ---- widgets (same style as your TL/CWPS PT tiles) ----
