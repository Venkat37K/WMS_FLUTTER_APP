...
class FeederMain1TlStatusScreen extends StatefulWidget {
  const FeederMain1TlStatusScreen({super.key});

  @override
  State<FeederMain1TlStatusScreen> createState() => _FeederMain1TlStatusScreenState();
}
...
class _FeederMain1TlStatusScreenState extends State<FeederMain1TlStatusScreen> {
  ...
  // Display tuning (kept same as TL pages)
  ...
  // Titles per your sheet: A21->FMA-1 ... A32->FMA-12
  String _titleFor(int tagIndex) => 'FMA - ${tagIndex - 20}';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('FEEDER MAIN 1 • Pressure', style: TextStyle(color: Colors.white)),
                    ...
                    children: [
                      ...
                      ...result.items.map((r) {
                        ...
                        return Padding(
                          ...
                          child: _PTTile(
                            title: _titleFor(r.index), // FMA - 1..12
                            value: r.value,
                            unit: unit,
                            statusText: st.text,
...
class _TLReading {
  final int index;        // 21..32 for Feeder Main 1
...
// ---- widgets (same as your TL/RWTL tiles) ----
